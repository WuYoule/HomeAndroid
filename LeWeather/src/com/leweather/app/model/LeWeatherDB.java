...
import com.leweather.app.db.LeWeatherOpenHelper;
...
public class LeWeatherDB {
	...
	// 将构造方法私有化
	private LeWeatherDB(Context context) {
		LeWeatherOpenHelper dbHelper = new LeWeatherOpenHelper(context,
				DB_NAME, null, VERSION);
		db = dbHelper.getWritableDatabase();
	}

	// 获取LeWeatherDB实例
	public synchronized static LeWeatherDB getInstance(Context context) {
		if (leWeatherDB == null) {
			leWeatherDB = new LeWeatherDB(context);
		}
		return leWeatherDB;
	}
