package com.myqq.horizontalscrollview;
...
public class MyHorizontalScrollView extends HorizontalScrollView{
	...
	public MyHorizontalScrollView(Context context, AttributeSet attrs) {
		...
		DisplayMetrics outMetrics=new DisplayMetrics();//分辨率
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			...
			Log.i("onTouchEvent中scrollX", scrollX+"");
			Log.i("onTouchEvent中mMenuWidth", mMenuWidth/2+"");
			if(scrollX>mMenuWidth/2){
				Log.i("scrollX>mMenuWidth/2 ???", "是");
				//有动画效果的隐藏
				this.smoothScrollTo(mMenuWidth, 0);
			}else{
				Log.i("scrollX>mMenuWidth/2 ???", "否");
